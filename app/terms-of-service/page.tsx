          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                By accessing and using the services provided by Trigital
                Technologies Pvt Ltd ("Trigital," "we," "our," or "us"), you
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                Trigital provides software development, cloud consulting, AI/ML
                solutions, digital transformation services, and SaaS products
                including but not limited to NIPIGE platform. We reserve the right to modify, suspend, or
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-4">
                ...
                to register for an account. When registering, you agree to:
              </p>
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                images, software, and source code, are owned by Trigital or its
                licensors and are protected by international copyright,
                trademark, patent, trade secret, and other intellectual property
                laws. You may not reproduce, distribute, modify, create
                derivative works, publicly display, or otherwise exploit any of
                our proprietary materials without our prior written consent.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-700 dark:text-gray-300">
                <li>
                  You agree to pay all fees associated with your subscription or
                  purchase
                </li>
                <li>
                ...
                <li>
                  We reserve the right to change our pricing with prior notice
                </li>
                <li>
                ...
                <li>
                  All fees are exclusive of applicable taxes, which you are
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                We strive to ensure our services are available and functioning
                properly, but we do not guarantee uninterrupted or error-free
                service. We reserve the right to modify, suspend, or discontinue
                any part of our services at any time, with or without notice. We
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                our services will be uninterrupted, secure, or error-free, or
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                To the fullest extent permitted by applicable law, Trigital
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                You agree to indemnify, defend, and hold harmless Trigital and
            ...
            <div>
              ...
              <p className="text-gray-700 dark:text-gray-300 leading-relaxed">
                ...
                use our services after any revisions become effective, you agree
            ...
            <div>
              ...
              <div className="bg-gray-50 dark:bg-slate-700 p-6 rounded-lg">
                ...
                <p className="text-gray-700 dark:text-gray-300 mb-2">
                  <strong>Email:</strong> info@trigital.in
                </p>
                <p className="text-gray-700 dark:text-gray-300">
                  <strong>Phone:</strong> +91 7013870575
                </p>
              </div>
            </div>
          </div>
